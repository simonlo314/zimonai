...
- Every article begins with a self-contained reader overview, then separates official-source facts, practical interpretation and evidence limitations. The overview must let a reader understand the complete issue without reading the headline or body: what the document, record or event is, the decisive facts, the central limitation, the buyer or industry consequence and a useful ZIMONAI editorial interpretation.
- A knowledge overview is not a binary-answer field. Do not begin it—or any sentence within it—with “No,” “Yes,” “It depends,” “Not necessarily,” “不能,” “可以,” “不一定” or equivalent verdict wording. Preserve necessary evidence boundaries in natural prose instead of stacking negative claims or disclaimers.
- Do not substitute formula compliance for editorial quality. Length, sentence-count and phrase checks are release gates, but the reviewer must still read all three locale versions and confirm that each one is accurate, complete, natural and genuinely useful on its own.
