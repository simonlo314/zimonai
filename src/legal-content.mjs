  ...
  en: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'A portal account stores the verified email address, preferred language, internal account reference, linked case and order references, submitted case fields, status history and the delivery record for necessary account, order and service notifications. Sign-in may use Google or a short-lived one-time code sent by email. ZimonAI does not store Google passwords or Google access tokens, and does not keep a readable copy of a one-time code after verification.'
          ]
        },
        {
        ...
        },
        {
          ...
          items: [
            'Infrastructure, account sign-in, transactional-email, payment, accounting or professional service providers',
          ...
          note: 'Only the information reasonably needed for that purpose should be shared. A service used to send one-time codes or operational notifications may process the recipient address, message content and delivery records under its own service arrangements. Supplier contact or on-site work is carried out only within the agreed service scope.'
        },
        {
          title: 'International processing',
          paragraphs: [
            'ZimonAI coordinates work across Taiwan and Shenzhen and uses international infrastructure and payment providers. Information may therefore be processed in more than one country or region, where privacy rules may differ from those where you are located.',
    ...
    paymentTerms: {
      ...
      sections: [
        ...
        { title: 'Order review and acceptance', paragraphs: ['Online purchase requires a signed-in client account so the confirmed order can be linked to the correct workspace. Signing in does not create a charge; Stripe Checkout opens only after the client reviews the service and confirms the purchase action.', 'Payment opens the intake process. It does not by itself confirm that submitted material fits the purchased scope. ZimonAI reviews the service item, payment status and intake material before work begins.', 'If the request cannot be accepted, ZimonAI will explain the issue and, before work begins, offer an appropriate scope adjustment or refund the affected payment. ZimonAI does not automatically convert a payment into another service.'] },
  ...
  'zh-tw': {
    ...
    privacy: {
      ...
      sections: [
        ...
        { title: '可能提供資料的情況', paragraphs: ['ZimonAI 不出售個人資料。只有在完成約定工作確有需要、你指示或授權、營運必要服務需要，或法律要求揭露時，才會提供相關資料。'], items: ['網站、帳戶登入、交易通知 Email、付款、會計或專業服務商', '案件需要直接確認時的供應商、發證單位、實驗室或已納入範圍的專業人員', '依法必須揭露或為維護合法權益所需的主管機關、法院或專業顧問'], note: '每次只應提供該目的合理所需的資料。寄送驗證碼或營運通知的服務商，可能依其服務安排處理收件地址、訊息內容與寄送紀錄。供應商聯絡或現場工作，仍以雙方確認的服務範圍為準。' },
        { title: '跨境處理', paragraphs: ['ZimonAI 採台灣 × 深圳協作，並使用跨國網站與付款服務，因此資料可能在不同國家或地區處理；當地的個資規則可能與你所在地不同。', '由外部服務商處理時，會依該服務商的合約與安全安排執行。若個別案件需要新的接收方或非一般性的資料移轉，應在案件範圍中另行確認。'] },
    ...
    paymentTerms: {
      ...
      sections: [
        ...
        { title: '訂單核對與承接確認', paragraphs: ['線上購買需要先登入客戶帳戶，讓付款確認後的訂單能正確連到你的工作區。登入本身不會產生費用；只有再次檢查服務內容並主動確認購買後，才會開啟 Stripe 付款頁。', '付款會開啟收件流程，但不代表提交內容必然符合所購買的範圍。開始工作前，ZimonAI 會核對服務項目、付款狀態與案件資料。', '若案件無法承接，ZimonAI 會說明原因，並在工作開始前提出適合的範圍調整，或退還受影響的款項；不會擅自把付款轉成其他服務。'] },
  ...
  'zh-cn': {
    ...
    privacy: {
      ...
      sections: [
        ...
        { title: '可能提供资料的情况', paragraphs: ['ZimonAI 不出售个人信息。只有在完成约定工作确有需要、你指示或授权、运营必要服务需要，或法律要求披露时，才会提供相关资料。'], items: ['网站、账户登录、交易通知邮件、付款、会计或专业服务商', '案件需要直接确认时的供应商、发证机构、实验室或已经纳入范围的专业人员', '依法必须披露或为了维护合法权益所需的主管机关、法院或专业顾问'], note: '每次只应提供该目的合理所需的资料。发送验证码或运营通知的服务商，可能按照其服务安排处理收件地址、消息内容与发送记录。供应商联系或现场工作，仍以双方确认的服务范围为准。' },
        { title: '跨境处理', paragraphs: ['ZimonAI 采用台湾 × 深圳协作，并使用跨国网站与付款服务，因此资料可能在不同国家或地区处理；当地的个人信息规则可能与你所在地区不同。', '由外部服务商处理时，会按照该服务商的合同与安全安排执行。如果个别案件需要新的接收方或非常规资料传输，应在案件范围中另行确认。'] },
    ...
    paymentTerms: {
      ...
      sections: [
        ...
        { title: '订单核对与承接确认', paragraphs: ['在线购买需要先登录客户账户，使付款确认后的订单可以正确关联到你的工作区。登录本身不会产生费用；只有再次检查服务内容并主动确认购买后，才会打开 Stripe 付款页面。', '付款会开启收件流程，但不代表提交内容必然符合所购买的范围。开始工作前，ZimonAI 会核对服务项目、付款状态与案件资料。', '如果项目无法承接，ZimonAI 会说明原因，并在工作开始前提出适合的范围调整，或退还受影响的款项；不会擅自把付款转换成其他服务。'] },
