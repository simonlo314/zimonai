...
I18N.en.pages = {
  ...
  game: {
    ...
    cd_n: 'EPR 240W',
    cd_d: 'Newest standard. Zero bottleneck.',
    cc_n: 'Cheap No-name',
    cc_d: 'Bargain cable. Only 15W, heats up fast.',
    ...
    tip_timeout: 'Charger or cable is a bottleneck — try higher wattage.',
    tip_overheat: 'Cable resistance and high wattage caused overheating.',
    res_timeout: 'Time\'s up! Charging too slow.',
...
I18N['zh-Hant'].pages = {
  ...
  game: {
    ...
    tip_timeout: '充電器或線材是瓶頸，試試更高瓦數的配件。',
    tip_overheat: '線材阻抗加上高瓦數導致過熱。',
    res_timeout: '時間到！充電太慢了。',
    cta_t: '想測試你真實的充電配置？',
